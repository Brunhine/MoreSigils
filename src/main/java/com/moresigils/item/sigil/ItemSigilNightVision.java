...
public class ItemSigilNightVision extends ItemSigilBaseToggleable implements IPotionSigil
{
    ...
    {
        super("NightVision", ConfigHandler.sigilNightVisionCost);
        MinecraftForge.EVENT_BUS.register(this);

        ItemStack stack = PotionUtils.addPotionToItemStack(new ItemStack(Items.POTIONITEM), PotionTypes.NIGHT_VISION);
        this.potionEffect = PotionUtils.getEffectsFromStack(stack).get(0);

        this.mobEffect = MobEffects.NIGHT_VISION;
    }
