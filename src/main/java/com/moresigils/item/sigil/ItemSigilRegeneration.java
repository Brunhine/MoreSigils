...
public class ItemSigilRegeneration extends ItemSigilBaseToggleable implements IPotionSigil
{
    private final PotionEffect potionEffect;
    private final Potion mobEffect;

    public ItemSigilRegeneration()
    {
        super("Regeneration", ConfigHandler.sigilRegenerationCost);
        MinecraftForge.EVENT_BUS.register(this);

        ItemStack stack = PotionUtils.addPotionToItemStack(new ItemStack(Items.POTIONITEM), PotionTypes.REGENERATION);
